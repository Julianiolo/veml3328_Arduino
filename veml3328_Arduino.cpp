...
uint8_t VEML3328::begin(TwoWire* wire_ = &Wire, const uint8_t device_addr_ = VEML3328_DEF_ADDR, bool wake_up) {
...
uint8_t VEML3328::Config::getX(uint16_t mask, uint8_t shift) {
...
VEML3328::SD_t VEML3328::Config::getSD(void) {
...
VEML3328::CS_t VEML3328::Config::getCS(void) {
...
VEML3328::DG_t VEML3328::Config::getDG(void) {
...
VEML3328::Gain_t VEML3328::Config::getGain(void) {
...
VEML3328::Sens_t VEML3328::Config::getSens(void) {
...
VEML3328::IT_t VEML3328::Config::getIT(void) {
...
VEML3328::Mode_t VEML3328::Config::getMode(void) {
...
VEML3328::Trig_t VEML3328::Config::getTrig(void) {
...
VEML3328::Config VEML3328::getConfig(uint8_t* error = NULL) {
